...
use openvm_native_recursion::{utils::reduce_32, vars::OuterDigestVariable};
const OUTER_DIGEST_SIZE: usize = 1; // Note: This is copied directly from openvm_native_recursion source code
