...
use crate::arithmetics::{
    challenger_multi_observe, eq_eval, eval_ceno_expr_with_instance, print_ext_arr, print_felt_arr,
...
pub struct RotationClaim<C: Config> {
    left_evals: Array<C, Ext<C::F, C::EF>>,
    right_evals: Array<C, Ext<C::F, C::EF>>,
    target_evals: Array<C, Ext<C::F, C::EF>>,
    left_point: Array<C, Ext<C::F, C::EF>>,
    right_point: Array<C, Ext<C::F, C::EF>>,
    origin_point: Array<C, Ext<C::F, C::EF>>,
}
    ...
    for (i, layer) in gkr_circuit.layers.iter().enumerate() {
        ...
        builder.if_eq(has_rotation, Usize::from(1)).then(|builder| {
            ...
            let RotationClaim {
                ...
                builder,
                gkr_proof.num_var_with_rotation,
                &rotation_proof,
        ...
        let max_num_variables = builder.unsafe_cast_var_to_felt(gkr_proof.num_var_with_rotation);
...
pub fn verify_rotation<C: Config>(
    ...
    let max_num_variables = builder.unsafe_cast_var_to_felt(max_num_variables);
