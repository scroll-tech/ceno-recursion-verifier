...
use crate::arithmetics::{challenger_multi_observe, eval_ceno_expr_with_instance, evaluate_ceno_expr, print_ext_arr, print_felt_arr, PolyEvaluator, UniPolyExtrapolator};
...
use crate::{
    ...
    tower_verifier::{
        binding::{PointVariable, PointAndEvalVariable},
